...
function createRouteAction(Element) {
  return (/*#__PURE__*/regeneratorRuntime.mark(function elementRouteAction() {
      return regeneratorRuntime.wrap(function elementRouteAction$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _effects.put)((0, _actions3.changeElement)(Element));
...
function interpolate(routes) {
  ...
  try {
    for (var _iterator2 = Object.keys(routes)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      if ((typeof rval === 'undefined' ? 'undefined' : _typeof(rval)) === 'object' && !_react2.default.isValidElement(rval)) {
        ...
        if (_react2.default.isValidElement(action)) {
          var retEnter = enter ? [enter] : entering;
          var retLeave = leave ? [leave] : leaving;
...
function amend(routes) {
  ...
  try {
    for (var _iterator3 = Object.keys(routes)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      if ((0, _actions3.isPrefixed)(segment) && Array.isArray(routes[segment])) {
